...
@ServiceProvider(service=JavaPlatformProvider.class, position=1_000)
public class JavaPlatformProviderOverride implements JavaPlatformProvider {
    ...
    public static void setDefaultPlatformOverride(String defaultPlatformOverride) {
        for (JavaPlatformProvider p : Lookup.getDefault().lookupAll(JavaPlatformProvider.class)) {
            if (p instanceof JavaPlatformProviderOverride) {
                ((JavaPlatformProviderOverride) p).dosetDefaultPlatformOverride(defaultPlatformOverride);
            }
        }
    }
